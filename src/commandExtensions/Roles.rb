...
module Roles
  ...
  command(:createrole,
          ...
          permission_message: 'It seems you do not have permission to manage roles.') do |event, *rolename|
  ...
  command(:changerolename, min_args: 2,
                           required_permissions: [:manage_roles],
                           permission_message: 'It seems you do not have permission to manage roles.') do |event, *rolename|
    newname = rolename[0]
    rolename = rolename[1..-1].join(' ')
  ...
  command(:assignrole, min_args: 2,
                       required_permissions: [:manage_roles],
                       permission_message: 'It seems you do not have permission to manage roles.') do |event, mention, *rolename|
