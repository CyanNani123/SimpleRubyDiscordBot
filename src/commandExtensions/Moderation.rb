...
module Moderation
  ...
  command(:ban,
          ...
          permission_message: 'You need permission to ban members first.',
          min_args: 2,
          max_args: 2,
          usage: 'please mention a user') do |event, mention, days = 0|
...
1) I don't have ban members permission.\n2) That user has a role higher or equal to mine.\nPlease make sure both are fixed and try again, thanks."
    ...
    begin
      ...
      event.channel.send_embed do |embed|
        ...
        embed.author = Discordrb::Webhooks::EmbedAuthor.new(name: "Beaner boi: #{dis}",
  ...
  command(:kick,
          ...
          permission_message: 'Im sorry but you don\'t have the necessary permission of: `KICK MEMBERS`.',
          min_args: 1,
          max_args: 1,
          usage: 'please mention a user') do |event, mention|
    if event.message.mentions.empty?
    ...
    begin
      ...
      event.channel.send_embed do |embed|
        ...
        embed.author = Discordrb::Webhooks::EmbedAuthor.new(name: "Who did the kick? #{event.user.distinct}",
                                                            icon_url: 'https://cdn.discordapp.com/embed/avatars/0.png')
      end
    rescue Discordrb::Errors::NoPermission
  ...
  command(:prune,
          ...
          permission_message: 'imma keep it real with u chief! You need permission to manage messages, come on bro we all do.') do |event, howmany|
